package com.smascaro.trackmixing.playback.controller
...
class MixPlayerServiceController @Inject constructor(
    ...
    fun onDestroy() {
        ...
        playbackStateManager.setPlayingStateFlag(PlaybackStateManager.PlaybackState.Stopped())
    }
    // endregion
    ...
    override fun onSongFinished() {
        playbackStateManager.setPlayingStateFlag(PlaybackStateManager.PlaybackState.Paused())
    ...
    private fun handleLoadTrack(args: ActionArgs?) {
        if (validateLoadTrackExtras(args)) {
            val track =
                args!!.bundle!!.get(MixPlayerService.EXTRA_LOAD_TRACK_PARAM_KEY) as com.smascaro.trackmixing.base.data.model.Track
            loadTrack(track)
    ...
    private fun loadTrack(track: com.smascaro.trackmixing.base.data.model.Track) {
    ...
    private fun playMaster() {
        ...
        io.launch {
            ...
            playbackStateManager.setPlayingStateFlag(PlaybackStateManager.PlaybackState.Playing())
        }
    }
