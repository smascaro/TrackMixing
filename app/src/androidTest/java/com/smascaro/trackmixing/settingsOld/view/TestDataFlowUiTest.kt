...
import com.smascaro.trackmixing.settings.testdata.download.DownloadTestDataActivity
import org.junit.Rule
import org.junit.Test

class TestDataFlowUiTest : UiTest() {
    @get:Rule
    val activityScenarioRule = ActivityScenarioRule(com.smascaro.trackmixing.settings.testdata.download.DownloadTestDataActivity::class.java)
